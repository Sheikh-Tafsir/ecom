...
import {TOAST_TYPE, ORDER_STATUS} from "@/utils/enums"
                ...
                <div className="max-w-5xl mx-auto mt-6 space-y-8">
                        ...
                        <CardContent className="p-8 md:p-12">
                            {isCancelled ? (
                                <div className="flex flex-col items-center justify-center py-6 text-center">
                                    ...
                                    <p className="text-slate-500 mt-2">This order has been {order?.status.toLowerCase()}. Please contact support if you have any questions.</p>
                                </div>
                            ) : (
                            ...
                            <div className="grid md:grid-cols-3 gap-8">
                                <div className="space-y-1">
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Estimated Delivery</p>
                                ...
                                <div className="space-y-1">
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Shipping Method</p>
                    ...
                    <div className="grid gap-8 lg:grid-cols-5">
                        ...
                        <div className="lg:col-span-3 space-y-8">
                                ...
                                <CardHeader className="bg-slate-50/50 border-b border-slate-50 p-8">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <CardDescription className="text-slate-500 font-medium mt-1">Where we're delivering your order</CardDescription>
                                        </div>
                                    </div>
                                </CardHeader>
                            ...
                            <Card className="border-slate-100 shadow-xl shadow-slate-200/50 rounded-lg overflow-hidden bg-white">
                                <CardHeader className="bg-slate-50/50 border-b border-slate-50 p-8">
                                    <CardTitle className="text-xl font-bold text-slate-800 tracking-tight">Order Items</CardTitle>
                                    <CardDescription className="text-slate-500 font-medium mt-1">Detailed list of products in this order</CardDescription>
                                </CardHeader>
                                <CardContent className="p-8">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            <Card className="border-slate-100 shadow-xl shadow-slate-200/50 rounded-lg overflow-hidden bg-white sticky top-24">
                                <CardHeader className="bg-slate-50/50 border-b border-slate-50 p-8">
                                    <CardTitle className="text-xl font-bold text-slate-800 tracking-tight">Payment Summary</CardTitle>
                                </CardHeader>
                                <CardContent className="p-8 space-y-6">
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex justify-between items-center pt-2">
                                            ...
                                            <span className="text-3xl font-black text-blue-600 tracking-tighter">${order?.totalPrice}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className={cn(
                                        ...
                                        <div className="flex items-center justify-between">
                                            <p className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Payment Status</p>
                                            <span className={cn(
                                        ...
                                        <div className="flex items-center gap-3">
                                            <div className={cn(
                                                ...
                                                {order?.paid ? <CheckCircle2 className="h-5 w-5"/> : <Clock className="h-5 w-5"/>}
                                            </div>
                                    ...
                                    <div className="pt-4 text-center">
                                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Need help with your order?</p>
                                        <Button variant="link" className="text-blue-600 font-bold text-sm mt-1">Contact Support</Button>
                                    </div>
                                </CardContent>
                            </Card>
                        </div>
