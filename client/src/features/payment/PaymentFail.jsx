...
export default function PaymentFail() {
    ...
    return (
        <div className="min-h-[80vh] flex items-center justify-center p-4 bg-slate-50/50">
            <Card
                className="max-w-md w-full border-slate-100 shadow-2xl shadow-slate-200/50 rounded-2xl overflow-hidden bg-white animate-in fade-in zoom-in duration-500">
                ...
                <CardContent className="p-8 space-y-6">
                    ...
                    <div className="text-center space-y-2">
                        <p className="text-sm text-slate-500 font-medium">
                            Don't worry, your order has been placed as <b>Pending</b>. You can try paying again or pay
