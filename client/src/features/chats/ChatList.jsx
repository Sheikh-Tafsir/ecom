...
import {CHAT_TYPE} from "@/constants/chat.constants";
                        ...
                        {getLastMessageTime(chat.lastSent)}
                                        ...
                                        <div className="flex items-center justify-between gap-2">
                                            ...
                                            {chat.unreadMessage > 0 && chat.lastSenderId != user?.id && (
                                                <span
                                                    className="flex items-center justify-center bg-blue-600 text-white text-[10px] font-bold h-4 w-4 rounded-full">
                          {chat.unreadMessage}
                        </span>
                                            )}
                                        </div>
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end" className="w-48">
                                        {chat.type != CHAT_TYPE.GROUP &&
                                            <DropdownMenuItem
                                                onClick={() => handleUserSelectorDialogOpen([], chat.otherUserId)}>
